...
- `formats/` — versioned project and asset format contracts (includes [`formats/rpg-save.md`](formats/rpg-save.md), [`formats/item-catalog-assets.md`](formats/item-catalog-assets.md), [`formats/ui-theme-assets.md`](formats/ui-theme-assets.md), [`formats/animator-controller-assets.md`](formats/animator-controller-assets.md), [`formats/world-forge-pantheon.md`](formats/world-forge-pantheon.md), [`formats/world-forge-archetypes.md`](formats/world-forge-archetypes.md), [`formats/world-forge-acts.md`](formats/world-forge-acts.md), [`formats/world-forge-mvp-readiness.md`](formats/world-forge-mvp-readiness.md), [`formats/world-forge-factions.md`](formats/world-forge-factions.md), [`formats/world-forge-relationships.md`](formats/world-forge-relationships.md), [`formats/world-forge-map.md`](formats/world-forge-map.md), [`formats/world-forge-quests.md`](formats/world-forge-quests.md), [`formats/world-forge-mcp.md`](formats/world-forge-mcp.md), [`formats/project-git-sync.md`](formats/project-git-sync.md))
...
- `architecture/agent-work-graph.md` — graph-engineering roles, cohesion cuts, shared locks, subagent vs same-chat policy
- `decisions/index.md` — accepted and superseded decisions
- `features/index.md` — feature inventory, status, and acceptance links
- `features/gearing-system.md` — Terraria-shaped gearing + soft affinity + Thrator (EPIC-0018 / DEC-0048)
- `features/marble-bag-rng.md` — gameplay RNG is named marble bags (loot, crits, procs; DEC-0057)
...
- `art/animation-craft.md` — animation vocabulary, Disney principles, combat windows, intent descriptors for Studio/MCP authoring (skill: [`skills/author-character-animation/SKILL.md`](../skills/author-character-animation/SKILL.md))
...
- `art/ui-chrome-direction.md` — shared in-game UI chrome (iron / gold / parchment) for HUD, dialogue, menus
