...
| Wind streak particle | image | Soft elongated S-curve alpha for ambient wind trails | generated 2026-07-27 (`tools/gen_wind_streak.py`) | Project-owned | `samples/open-world-rpg/assets/vfx/wind_streak.png` |
...
| Starting player Ashfell Blade turnaround | concept art | Player-character art direction for the Ashfell Blade starting archetype (legacy Squire filename) | 2026-07-03 import | Project-owned (author: project owner) | `context/art/reference/starting-player-squire-turnaround.png` |
