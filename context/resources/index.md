...
| Act 0 ammo inventory icons | image | Dedicated `crude_arrow` / `outrider_arrow` inventory PNGs (no longer reuse shortbow) | generated 2026-08-05 | Project-owned (see PROVENANCE) | `samples/open-world-rpg/assets/ui/icons/items/`; `context/design/item-icons/PROVENANCE.md` |
...
| Rune sigil flipbook 4×4 | image | Cyan–gold geometric seals for Runecaster charge/bolt VFX | generated 2026-08-04 (`tools/gen_rune_flipbook.py`) | Project-owned | `samples/open-world-rpg/assets/vfx/rune_sigil_flipbook_4x4.png` |
...
| Target dummy turnaround v1 | concept art | Low-poly Blockbench reference sheet for a medieval combat training dummy prop | generated 2026-08-12 with OpenAI image generation | Project-owned AI concept | `context/art/reference/target-dummy-turnaround.png` |
| Target dummy mesh v1 | mesh | Combat sandbox training dummy (Blockbench free-mesh, skinned Idle + HitReact) | bake 2026-08-19 from owner `Documents/Target Dummy.bbmodel`; skinned rebake 2026-08-19 | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/target_dummy.gltf`; source `tools/art/target-dummy/Target_Dummy.bbmodel`; bake `tools/bake_target_dummy.py`; animator `assets/animators/target_dummy.animator.json` |
...
| Tessera banner pole mesh | mesh | A0-02 appearance-courtyard kingdom banner pole | bake 2026-08-18 from Blockbench `.bbmodel` | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/tessera_banner_pole.gltf`; source `tools/art/tessera-banner-pole/`; bake `tools/bake_appearance_courtyard_kit.py` |
| Tessera banner pole atlas | texture | Base-color atlas for Tessera banner pole | bake 2026-08-18 from Blockbench export | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/tessera_banner_pole.png` |
| Corner tower stub mesh | mesh | A0-02 appearance-courtyard corner tower | bake 2026-08-18 from Blockbench `.bbmodel` | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/corner_tower_stub.gltf`; source `tools/art/corner-tower-stub/`; bake `tools/bake_appearance_courtyard_kit.py` |
| Corner tower stub atlas | texture | Base-color atlas for corner tower stub | bake 2026-08-18 from Blockbench export | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/corner_tower_stub.png` |
| Weapon rack mesh | mesh | A0-02 appearance-courtyard weapons rack | bake 2026-08-18 from Blockbench `.bbmodel` | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/weapon_rack.gltf`; source `tools/art/weapon-rack/`; bake `tools/bake_appearance_courtyard_kit.py` |
| Weapon rack atlas | texture | Base-color atlas for weapon rack | bake 2026-08-18 from Blockbench export | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/weapon_rack.png` |
| Workbench table mesh | mesh | A0-02 appearance-courtyard workbench | bake 2026-08-18 from Blockbench `.bbmodel` | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/workbench_table.gltf`; source `tools/art/workbench-table/`; bake `tools/bake_appearance_courtyard_kit.py` |
| Workbench table atlas | texture | Base-color atlas for workbench table | bake 2026-08-18 from Blockbench export | Project-owned (author: project owner) | `samples/open-world-rpg/assets/models/workbench_table.png` |
...
| Sword sweep ribbon | image | Tapered ivory/gold brush-stroke texture for Ashfell weapon-sweep VFX | generated 2026-08-10 with OpenAI image generation; chroma-key alpha removal | Project-owned | `samples/open-world-rpg/assets/vfx/generated/sword_sweep.png` |
| Sword sweep brush v2 | image | Layered ivory, gold, violet, and magenta brush texture for Ashfell aura/core sweep VFX | generated 2026-08-10 with OpenAI image generation; chroma-key alpha removal | Project-owned | `samples/open-world-rpg/assets/vfx/generated/sword_sweep_brush.png` |
