# TICKET-0141: Full regression suite green + publish benchmarks
...
Full regression suite green + publish benchmarks. Expand acceptance when this ticket moves to ready/active.
