# TICKET-0165: Shared World Forge graph camera + minimap helpers

- Epic: EPIC-0006
- Status: needs-approval
- Agent: cursor-agent
- Priority: P2
- Notion: https://app.notion.com/p/39fd3efc569581748796d93579a8bbca

## Goal

Extract shared camera/minimap; refactor relationship + dialogue canvases.
...
- [x] Camera fit/transform/hit-test helpers exist; both canvases use them; minimap draws AABB + view rect with click-to-pan.

## Out of scope

Schema changes; dialogue-only chrome.

## Dependencies

Owner override of M7 hold. Soft: 0166-0168
