# TICKET-0062: HUD information architecture for open-world RPG
...
Quest markers, faction cues, without clutter. Expand acceptance when this ticket moves to ready/active.

## Context links

- `context/planning/epics.md` (EPIC-0007)
- `context/roadmap.md`
- Related tickets in the same epic (see epics.md)
- Runtime foundation: [TICKET-0153](TICKET-0153.md) / [DEC-0024](../../decisions/index.md#dec-0024-mcp-hud-toolkit-with-lua-value-binds) (MCP HUD toolkit + Lua binds)
