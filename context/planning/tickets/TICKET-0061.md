# TICKET-0061: Mini-map (data, rendering, fog-of-war policy)
...
Depends on map/region IDs from World Forge. Expand acceptance when this ticket moves to ready/active.
