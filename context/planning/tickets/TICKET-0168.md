# TICKET-0168: Dialogue graph toolbar + shortcuts

- Epic: EPIC-0006
- Status: needs-approval
- Agent: cursor-agent
- Priority: P2
- Notion: https://app.notion.com/p/39fd3efc569581c7b68bddc11ee34b17

## Goal

Toolbar buttons + keyboard shortcuts + minimal mutation undo stack.
...
- [x] Toolbar actions work; shortcuts when graph focused; undo/redo for graph mutations.

## Out of scope

Full align suite (0169); live Preview (0177).

## Dependencies

Owner override of M7 hold. Soft: 0165-0167
