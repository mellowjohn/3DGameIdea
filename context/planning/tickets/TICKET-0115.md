# TICKET-0115: Sandboxed Lua collision-query bindings

- Epic: EPIC-0006
- Status: proposed
- Agent: unassigned
- Priority: P3
- Notion: https://app.notion.com/p/39ad3efc569581a0bbd8fe17f2db3023

## Goal

Sandboxed Lua collision-query bindings. Expand acceptance when this ticket moves to ready/active.

## Context links

- `context/planning/epics.md` (EPIC-0006)
- `context/roadmap.md`
