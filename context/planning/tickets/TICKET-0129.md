# TICKET-0129: Wire inventory/quest/dialogue/save-load in one region

- Epic: EPIC-0011
- Status: proposed
- Agent: unassigned
- Priority: P3
- Notion: https://app.notion.com/p/39ad3efc56958106a159f2148382d1ef

## Goal

Wire inventory/quest/dialogue/save-load in one region. Expand acceptance when this ticket moves to ready/active.

## Context links

- `context/planning/epics.md` (EPIC-0011)
- `context/roadmap.md`
