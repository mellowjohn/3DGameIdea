# TICKET-0113: Abilities schema + Lua bindings (safe subset)
...
Abilities schema + Lua bindings (safe subset). Expand acceptance when this ticket moves to ready/active.
