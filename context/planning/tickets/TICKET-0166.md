# TICKET-0166: Dialogue node readability + display modes

- Epic: EPIC-0006
- Status: needs-approval
- Agent: cursor-agent
- Priority: P2
- Notion: https://app.notion.com/p/39fd3efc569581ba9f4ae14308b9e1bc

## Goal

Compact/Standard/Expanded node chrome with speaker, lines, type, choice count, icons, selection.
...
- [x] Display modes switch; nodes show speaker + 1-2 lines + type badge + choice count + warning/flag icons; selection outline.

## Out of scope

Schema v2 node types; curved edges.
