# TICKET-0204: World Forge hydrology + ferry route map authoring
...
Extend World Forge Map canvas to plan hydrology (river/lake/sea regions) and ferry route polylines linked to dock POIs ΓÇö metadata only; meshes stay in Sculpt ([DEC-0039](../../decisions/index.md#DEC-0039-water-swim-and-hydrology-authoring)).
...
- SQ-10 Island Ferry ΓÇö [`side-quest-catalog.md`](../../story/side-quest-catalog.md)
...
Soft: TICKET-0187 map canvas. Parallel with TICKET-0202.
...
Schema field names open ΓÇö finalize in format doc during implementation.
