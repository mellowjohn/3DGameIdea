...
As the free camera moves, adjacent cells load and distant cells unload while preserving seamless shared borders between generated meshes. A unit test walks a coarse grid across the accepted **16×16 km (256 km²)** world extent and verifies resident terrain cells stay bounded. Amortized + view-biased stream behavior is covered in the `terrain` suite.
