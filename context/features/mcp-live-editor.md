...
- `engine_asset_apply` — create or update prefab, material, or particle (`*.particle.json`) JSON; validate; refresh catalog / register particle emitters; `action: refresh_catalog` rescans without writing
