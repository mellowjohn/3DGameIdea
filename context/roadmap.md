...
- **M5 exit gate (TICKET-0110):** `engine test --suite m5-exit` + `engine animation-preview` provide headless verification; see [`features/animator.md`](features/animator.md). Remaining before M6: **audio** (TICKET-0107); editor Animation tools panel (TICKET-0135); GPU skinning polish deferred.
