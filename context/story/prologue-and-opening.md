...
The protagonist begins as an ordinary resident of a Tessera settlement. A draft opening concept has the settlement destroyed and a Wild God revive the protagonist. The Wild God gives an omen-like warning that the Shroud must be removed from the Usurper. Initially driven by vengeance, the protagonist intends to destroy the Shroud.

## Dramatic Irony Proposal
...
- Decide whether Frangitur is speaking from within the Shroud, through it, or from elsewhere.
- Decide whether the player hears Frangitur before character creation or only the audience does.
- Define the Wild God's identity, motive, and knowledge of the Shroud.
- Reconcile the burned-settlement revival with the draft, Calrenoth deployment, and tutorial battlefield.
- Determine whether “adventurers” is intentionally plural when the scene addresses one player character.
- Final dialogue requires a dedicated script pass; this entry preserves intent rather than establishing final wording.
