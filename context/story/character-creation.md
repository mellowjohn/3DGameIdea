...
- Decision: [DEC-0009](../decisions/index.md#dec-0009-starting-archetype-character-creation)
...
The protagonist is not fixed as a Squire. **Squire**, **Archer**, and **Acolyte** are the three starting archetypes under the current plan.
...
- Obligation to a noble house or tribe chosen during creation (details TBD).
...
| Archetype | Role | Draft advancement |
| --- | --- | --- |
| Squire | Melee trainee, noble-house path | Knight or Warrior/Barbarian by faction reputation |
...
- Define noble houses, tribes, and the obligation chosen during creation.
