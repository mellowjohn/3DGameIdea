...
| --- | --- | --- | --- | --- |
| D-P2-08 | Exact theater **borders** + v1 **4×4 km** footprint + locked **Calrenoth** / **Ledgeport** / **Porto Lucente** world coords | Act 0 Landfall map anchors + Act 1 ferry soft-travel | Soft callouts only until locked; Calrenoth tip + Ledgeport-as-Act-1-focus + ferry to **Porto Lucente** U-bay already confirmed. **2026-07-29:** deferred to **level design / map iteration** (not a story-line lock) | |
| D-P1-21b | Name **1–2 House Ashfell faces** (quest givers / mentors) | Melee lane org story; Act 1 house pressure | **House Ashfell** display name **confirmed** 2026-07-29 (D-P1-21). Faces deferred to Act 1 authoring — do not invent | |
| D-P1-22 | Name **Outrider Lodge** and **Runecaster Guild** first contacts (or roles-only) | Lane org quests; optional Act 0 Calrenoth **glimpses** of Lodge/Guild/Ashfell fighters | Orgs + **Outrider Lodge** name locked; person names Dom-owned; Act 0 focus stays Calrenoth tutorial — full contacts = Act 1 | |

---

## P1 — Act 1 coastal / hub / succession (after Act 0)
...
| D-P1-14 | Lock **Vanessa introduction** beat: Ledgeport road, banquet (SQ-06), camp, or Cristallo-path first contact? | Companion unlock timing; dialogue authoring order | Beat A1-04 timing **open**. SQ-06 can introduce her as Cristallo-adjacent; else road default. Camp tutorial (D-P1-19) may assume Arkand-only until this locks | |
...
### Act 0 create backlog (Landfall locks landed 2026-07-29)
...
| **P2** | Ashfell Blade house patron / Outrider Lodge + Runecaster Guild contacts | Yes (D-P1-21b / D-P1-22) | D-P1-21b / D-P1-22 | House name locked; faces Act 1 ([DEC-0044](../decisions/index.md#dec-0044-starting-archetype-lane-orgs-and-rename)) |
...
### Quests to create / finish seeding (Act 1+)
...
| **P1** | Ashfell / Outrider Lodge / Runecaster Guild first quests | Beat stubs only | After D-P1-21b / D-P1-22; readiness `archetype_lane_org_quests` |
| **P1** | Act 1 Cristallo dual-path intro (main beat package) | Beat A2-01 early slice | After D-P1-17; ferry **Ledgeport** → **Porto Lucente** |
...
| **P2** | Cristallo church/state + White Lotus induction | After titles; crystal = **Claritas** on leader’s staff |
| **P2** | Companion loyalty stress (Act 3) | After D-P2-12 |
| **P2** | SQ-05–11 trees | After NPC name lock |

### Other prioritize soon (Act 1+)
...
| **P1** | Dual-path travel soft-gates (Thalassar coast ↔ Cristallo ferry) | Act 1 structure |
...
3. **D-P1-12** / **D-P1-15** — Thalassar succession cast + A1-05 quest title
4. **D-P1-13** / **D-P1-14** — Ledgeport faces + Vanessa intro
5. **D-P1-16** — Pneumyra / false-cult reveal timing
6. **D-P2-13** — harden ending matrix from 2026-07-29 soft sketch (Shroud destroy vs control)
